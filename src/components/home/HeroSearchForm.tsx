...
export default function HeroSearchForm({ className = "", compact = false }: { className?: string; compact?: boolean }) {
  ...
  const [pickupPosition, setPickupPosition] = useState<"top" | "bottom">("bottom");
  ...
  const openPickupDropdown = (e?: React.FocusEvent<HTMLInputElement> | React.MouseEvent<HTMLInputElement>) => {
    ...
    if (e && typeof window !== "undefined") {
      ...
      const position = (spaceBelow < 260 && spaceAbove >= 260) ? "top" : "bottom";
      setPickupPosition(position);
    }
    setShowPickupDropdown(true);
  };

  const openDropDropdown = (e?: React.FocusEvent<HTMLInputElement> | React.MouseEvent<HTMLInputElement>) => {
  ...
  return (
    <div className={`w-full ${className}`}>
        ...
        <div className="flex flex-wrap items-center justify-center lg:justify-start gap-2 mb-3 lg:mt-5">
          <button
            type="button"
            onClick={() => {
              setActiveTab("oneWay");
        ...
        <div
          ref={formRef}
          className="backdrop-blur-[10px] border border-[#fafbfc38] rounded-[5px] p-4 sm:p-5 lg:p-6 shadow-2xl relative z-40"
        >
          {/* Form Content */}
                ...
                <div className="space-y-1.5 relative">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onFocus={(e) => openPickupDropdown(e)}
                      onClick={(e) => openPickupDropdown(e)}
                      onChange={(e) => {
                  ...
                  {showPickupDropdown && (
                    <div className={`absolute left-0 right-0 z-[100] bg-[#131722] border-2 border-[#23293a] rounded-[5px] shadow-[0_20px_50px_rgba(0,0,0,0.9)] max-h-56 overflow-y-auto py-1 ${pickupPosition === "top" ? "bottom-[105%] top-auto mb-1" : "top-[105%] bottom-auto mt-1"}`}>
                      {isPickupLoading ? (
                ...
                <div className="space-y-1.5 relative">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      value={dropLocation}
                      onFocus={(e) => openDropDropdown(e)}
                      onClick={(e) => openDropDropdown(e)}
                      onChange={(e) => {
                  ...
                  {/* Real-time Autocomplete Dropdown */}
                  {showDropDropdown && (
                    <div className={`absolute left-0 right-0 z-[100] bg-[#131722] border-2 border-[#23293a] rounded-[5px] shadow-[0_20px_50px_rgba(0,0,0,0.9)] max-h-56 overflow-y-auto py-1 ${dropPosition === "top" ? "bottom-[105%] top-auto mb-1" : "top-[105%] bottom-auto mt-1"}`}>
                      {isDropLoading ? (
                        <div className="px-3.5 py-3 text-xs text-gray-400 flex items-center gap-2">
                          <Loader2 className="w-3.5 h-3.5 text-[#f59e0b] animate-spin" />
                          <span>Searching locations...</span>
            ...
            {activeTab === "roundTrip" && (
              <div className={`grid ${tripGridColumns} gap-3.5 items-end`}>
                ...
                <div className="space-y-1.5 relative">
                  ...
                  >
                    <CalendarIcon className="w-4 h-4 text-[#f59e0b] shrink-0" />
                    <span className="truncate font-medium text-xs sm:text-sm">{formatDateDisplay(selectedDate)}</span>
                  </button>
                ...
                <div className="space-y-1.5 relative">
                  ...
                  >
                    <CalendarIcon className="w-4 h-4 text-[#f59e0b] shrink-0" />
                    <span className="truncate font-medium text-xs sm:text-sm">{formatDateDisplay(returnDate)}</span>
                  </button>
